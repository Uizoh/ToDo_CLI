...
def main():
    ...
    while True:
        ...
        match user_response:
            case "l":
                core.print_list(todo_list)
            case "A":
                core.add_title(todo_list)
            case "a":
                core.add_task(todo_list)
            case "D":
                core.delete_title(todo_list)
            case "d":
                core.delete_task(todo_list)
            case "clear":
                core.clear_list(todo_list)
            case "exit":
